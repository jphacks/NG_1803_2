...
for path_num in range(3):
    ...
    if (path_num == 0):
        f = open('outputdata_201810271814/suntoryCocktailRecipe_translationData_ja.json', 'r', encoding="utf-8_sig")
    else:
        f = open(['outputdata_201810271814/suntoryCocktailRecipe_translationData_en.json',
                  'outputdata_201810271814/suntoryCocktailRecipe_translationData_zh.json'][path_num-1], 'r', encoding="utf-8_sig",
                 errors="ignore")
